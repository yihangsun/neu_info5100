...
public class Account
{
    ...
    // Subtracts the transaction debit amount from the current balance, 
    // and returns the new balance.  
    // No condition check is required for subtracting.
    public double DebitTransaction(double debitAmount)
    {
        return CurBalance -= debitAmount;
    }

    // Adds the transaction credit amount to the current balance, 
    // and returns the new balance.
